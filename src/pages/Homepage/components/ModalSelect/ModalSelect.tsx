...
const ModalSelect = ({ title, subtitle, colSpan = 1, arrowIconBefore = false }: ModalSelectPropsType) => {
  return (
    <div
    ...
    >
      ...
      {arrowIconBefore && (
        <span className="absolute top-1/2 -left-4 z-[1] flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded-full bg-white">
